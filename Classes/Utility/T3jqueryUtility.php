...
class T3jqueryUtility
{
     ...
     * @return void
     */
    public static function addJqJS()
    {
     ...
     * @return array
     */
    public static function getJqueryConfiguration($version = null)
    {
        if ($version === null) {
            $confArr = T3jqueryUtility::getConf();
     ...
     * @return array
     */
    public static function getJqueryUiConfiguration($version = null)
    {
        if ($version === null) {
            $confArr = T3jqueryUtility::getConf();
     ...
     * @return array
     */
    public static function getJqueryToolsConfiguration($version = null)
    {
        if ($version === null) {
            $confArr = T3jqueryUtility::getConf();
     ...
     * @return array
     */
    public static function getJqueryBootstrapConfiguration($version = null)
    {
        if ($version === null) {
            $confArr = T3jqueryUtility::getConf();
     ...
     * @return void
     */
    public function addJqJsByHook($params)
    {
        $confArr = T3jqueryUtility::getConf();
        if (T3jqueryUtility::isIntegrated()) {
     ...
     */
    public static function getJqJS($urlOnly = false)
    {
     ...
     */
    public static function getJqName()
    {
        $confArr = T3jqueryUtility::getConf();
     ...
     * @return integer
     */
    public static function getIntFromVersion($versionString = null)
    {
     ...
     * @return void
     */
    public static function addJS($content, $conf)
    {
     ...
     * @return void
     */
    public static function addJsFile($file, $conf = array())
    {
